...
\begin{frame}
  ...
  \end{itemize}
  \begin{tikzpicture}[remember picture,overlay]
    \visible<1-5>{\node at (2,-1.5) {\pgfuseimage{rviz}};}
    \visible<2-5>{\node at (3.5,-1.5) {\pgfuseimage{rosbag-slam}};}
    \visible<3-5>{\node at (5,-1.5) {\pgfuseimage{rxplot}};}
    \visible<4-5>{\node at (6.5,-1.5) {\pgfuseimage{rxgraph}};}
    \visible<5>{\node at (8,-1.5) {\pgfuseimage{rqt}};}
  \end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
    ...
    \matrix[anchor=west] at (0,-2.5)
      {
        ...
        \node[roscode]
        {rosrun turtlesim turtlesim\_node \_\_name:=my\_turtle};\\
        \node[roslist]
...
\begin{frame}{Vérifier son installation ros - \textbf{roswtf}}
  ...
  \end{itemize}
  {\tiny Tutorial Getting started with roswtf : \url{http://wiki.ros.org/ROS/Tutorials/Getting started with roswtf}};
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \matrix[anchor=west] at (0,-2.5)
      {
        ...
        \node[roscode]
        {rosbag record -a \\
         rosbag record -O subset /turtle1/command velocity /turtle1/pose};\\
        \node[roslist]
        {Le nom du fichier démarre avec l'année, la date et le temps et le suffixe .bag};\\
        \node[roslist]
        {\tiny Tutorial Recording and play back data \url{http://wiki.ros.org/ROS/Tutorials/Recording and playing back data}};\\
      };
  \end{tikzpicture}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
